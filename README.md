...
V0.9.0 是 **YouTube Search 最小正式 adapter 版本**，建立在 V0.8.x YouTube tiny probe 和 readiness memo 之上：
...
YouTube live 失败、空结果或全低相关结果不会覆盖上一份成功报告，错误详情请看：
...
tests/test_report_labels.py # YouTube 报告显示频道来源，不显示成 Reddit subreddit
